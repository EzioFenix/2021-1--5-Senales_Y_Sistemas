...
$$G(s)=\frac{1}{(s(s+3)+1)}$$	
$$G(s)=\frac{1}{s^{2}+3s+1}$$	
\includegraphics[scale=0.5]{../Downloads/DESCARGAS/G3.jpg}\\ 
Polos: $P_{1}=-2.618$ y $P_{2}=-0.382$\\\\
Respuesta al escalón del sistema:\\
\includegraphics[scale=0.4]{../Downloads/DESCARGAS/G5.jpg}\\
Si k=-10:
$$G(s)=\frac{-10}{(s(s+3)-10)}$$	
$$G(s)=\frac{-10}{s^{2}+3s-10}$$
\includegraphics[scale=0.36]{../Downloads/DESCARGAS/G4.jpg}\\ 	
Polos: $P_{1}=-5$ y $P_{2}=2$\\\\
Respuesta al escalón del sistema:\\
\includegraphics[scale=0.36]{../Downloads/DESCARGAS/G6.jpg}\\
